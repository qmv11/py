...
ten_sv.extend(["Giang", "Hoa"]) #noi them 1 list khac vao
print(ten_sv)
...
so_chan = [x for x in day_so if x % 2 == 0]   #lay ra cac so chan
so_le = [x for x in day_so if x % 2 != 0]    #lay ra cac so le
